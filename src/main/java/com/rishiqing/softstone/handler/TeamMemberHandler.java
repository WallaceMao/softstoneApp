 ...
 */
public class TeamMemberHandler implements ServiceHandler {

    private static final String METHOD_CREATE_NEW = GlobalConfig.queryConfig("apiMethodSyncTeamMember");
    private static final String TARGET_URL_CREATE_NEW = GlobalConfig.queryConfig("apiTargetUrlSyncTeamMember");
